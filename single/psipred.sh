...
CODE_DIR="/Users/qiangzhang/Desktop/Jessica实验/single" #Directory where all the script is located
PSIPRED_DIR="/home/dinglab/psipred" #Directory where psipred is installed
